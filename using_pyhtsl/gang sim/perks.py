...
ALL_PERKS: list[Perk] = [
    ...
    Perk(
        ...
        [
            ('&e+20⛁ Funds&7 on kill', 1000),
            ('&e+40⛁ Funds&7 on kill', 3000),
            ('&e+60⛁ Funds&7 on kill', 5000),
        ],
        PERK_3_TIER,
        PERK_3_COLOR,
    ),
    ...
    Perk(
        ...
        [
            ('&e+40% Distribution Funds', 1000),
            ('&e+80% Distribution Funds', 2500),
            ('&e+120% Distribution Funds', 10000),
            ('&e+160% Distribution Funds', 50000),
            ('&e+200% Distribution Funds', 100000),
        ],
        PERK_9_TIER,
        PERK_9_COLOR,
    ),
